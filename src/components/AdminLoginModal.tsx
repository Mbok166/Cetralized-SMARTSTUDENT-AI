    ...
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl border border-slate-200 overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs">
          ...
          {/* Institutional Note */}
          <div className="p-3 rounded-xl bg-indigo-50/70 border border-indigo-100/80 text-indigo-900 space-y-1.5">
            ...
            <p className="text-[11px] text-slate-600 leading-relaxed">
              Admin sessions are cryptographically verified via server-side JWT authentication to protect course management, employer listings, and candidate pipelines.
            </p>
          </div>
