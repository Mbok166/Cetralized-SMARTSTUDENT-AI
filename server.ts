...
import { Application, CourseProgress, DocumentItem, NotificationItem, Opportunity, StudentProfile } from './src/types';
...
// In-memory persistent state (seeded with realistic student & platform data)
let studentProfile: StudentProfile = { ...initialStudentProfile };
let courses = [...sampleCourses];
let courseProgressList: CourseProgress[] = [
  {
    courseId: 'course-01',
...
let applications: Application[] = [
  {
    ...
    studentId: initialStudentProfile.id,
    status: 'under_review',
    appliedDate: '2026-09-12',
    lastUpdated: '2026-09-14',
    notes: 'Submitted customized resume and portfolio link with recent React + Node project demo.',
    resumeAttached: 'Amina_Kimani_Resume_2026.pdf',
    coverLetter: 'I am thrilled to apply for the Software Engineering & Cloud Intern role at Safaricom...'
  },
  {
    id: 'app-02',
    ...
    lastUpdated: '2026-09-14',
    notes: 'Registered student team representing University & TVET collaboration.',
  }
];

let documents: DocumentItem[] = [...sampleDocuments];
let notifications: NotificationItem[] = [...sampleNotifications];
